...
export default function GenderPage({ gender }) {
  ...
  const title = gender === 'homme' ? 'Collection Homme' : 'Collection Femme';
  const subtitle = gender === 'homme'
    ? "L'élégance masculine réinventée"
